...
const individuals = {
    ...
    rGen: function() {
        let value = (Math.floor(Math.random() * (this._durationSixteen -2) +3)); 
        return value;
    },
